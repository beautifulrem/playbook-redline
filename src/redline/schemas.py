...
def export_schemas(out_dir: Path) -> None:
    ...
    models = {
        ...
        "execution-ledger-entry.v1.schema.json": ExecutionLedgerEntry,
        ...
        "playbook-identity-lock.v1.schema.json": PlaybookIdentityLock,
        ...
        "receipt.v3.3.schema.json": Receipt,
        "release-attestation.v1.schema.json": ReleaseBundleAttestation,
        ...
        "spec.v2.2.schema.json": RedlineSpec,
